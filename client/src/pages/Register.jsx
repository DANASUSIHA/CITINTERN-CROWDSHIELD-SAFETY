      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-tr from-brand-900 via-brand-800 to-indigo-900 text-white relative overflow-hidden">
        ...
        <div className="space-y-6 relative z-10 max-w-md">
          ...
          <p className="text-brand-100 text-base leading-relaxed">
            Create an account to report anomalies, receive safety warnings, and view live incident mappings. Together we build safer environments.
          </p>
        </div>
        ...
        <div className="w-full max-w-md space-y-6">
          <div className="text-center lg:text-left space-y-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
              Sign up for a new safety monitoring account
            </p>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="block w-full pl-11 pr-12 py-2.5 border border-gray-200 dark:border-slate-800 rounded-xl bg-white dark:bg-slate-900 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 dark:focus:ring-brand-500/20 dark:focus:border-brand-500 transition-all font-medium"
                  required
                />
                <button
                  type="button"
                ...
                >
                  {showPassword ? <EyeOff className="w-5 w-5" /> : <Eye className="w-5 w-5" />}
                </button>
              </div>
            </div>

            <div className="space-y-1.5">
              <label htmlFor="confirmPassword" className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                Confirm Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
